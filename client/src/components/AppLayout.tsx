...
const hubs = [
  {
    ...
    toolPrefixes: ["/tools/iep","/tools/social","/tools/pupil-passport","/tools/smart-targets","/tools/behaviour-plan","/tools/wellbeing","/send-screener","/visual-timetable","/worksheets","/differentiate","/tools/connected-resource","/tools/story-studio","/tools/activity-generator","/tools/visual-learning","/tools/adaptation-hub","/tools/teaching-agent","/tools/communication-board"],
  },
  {
...
const allKnownPaths: { path: string; label: string }[] = [
  ...
  { path: "/tools/connected-resource", label: "Connected Resource Generator" },
  { path: "/tools/story-studio", label: "Reading & Story Studio" },
  { path: "/tools/activity-generator", label: "Interactive Activity Generator" },
  { path: "/tools/visual-learning", label: "Visual Learning Studio" },
