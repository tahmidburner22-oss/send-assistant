...
const stats = [
  ...
  { label: "Lesson Saved/Plan", value: "~30 min", icon: Clock, color: "text-amber-600" },
          ...
          <CardContent className="p-4 flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-green-700/80 leading-relaxed">
                Start with the Medium Term Planner to map your sequence of learning, then use the Lesson Planner for individual lessons. Use the Differentiate tool to adapt materials for SEND and high-attaining pupils from the same base resource.
              </p>
            </div>
          </CardContent>
        </Card>
