...
// Pinned scroll section with zoom-in skill ladder card.
// V2: standard scale curve.
// V3: larger scale + longer pin + stronger rotation.
...
export default function ZoomParallax() {
  ...
  const maxScale = variant === "v3" ? 6.5 : 5.2;
  const maxRotate = variant === "v3" ? 4 : 2;

  const scale = useTransform(scrollYProgress, [0, 1], [0.85, maxScale]);
  const rotate = useTransform(scrollYProgress, [0, 1], [-6, maxRotate]);
