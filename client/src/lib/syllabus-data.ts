...
export const SYLLABUS_DATA: Record<string, Partial<Record<YearGroupKey, SyllabusTopic[]>>> = {
  ...
  biology: {
    ...
    "Year 9": [
      ...
      { topic: "Prokaryotic Cells", keyVocabulary: ["prokaryote", "bacteria", "cell wall", "plasmid", "flagellum"] },
      { topic: "Plant Cells", keyVocabulary: ["chloroplast", "cell wall", "vacuole", "photosynthesis", "stomata"] },
      { topic: "Mitosis", keyVocabulary: ["mitosis", "cell cycle", "chromosome", "division", "growth"] },
      { topic: "Meiosis", keyVocabulary: ["meiosis", "gamete", "chromosome", "genetic variation", "fertilisation"] },
      { topic: "Bioenergetics", keyVocabulary: ["photosynthesis", "respiration", "aerobic", "anaerobic", "metabolism"] },
      { topic: "Infection and Response", keyVocabulary: ["pathogen", "bacteria", "virus", "antibiotic", "vaccination"] },
    ],
    "Year 10": [
      ...
      { topic: "DNA Structure", keyVocabulary: ["double helix", "base pair", "nucleotide", "adenine", "thymine"] },
      { topic: "The Digestive System", keyVocabulary: ["digestion", "enzyme", "stomach", "intestine", "absorption"] },
      { topic: "Hormones", keyVocabulary: ["hormone", "gland", "insulin", "adrenaline", "oestrogen"] },
      { topic: "The Reflex Arc", keyVocabulary: ["neuron", "synapse", "reflex arc", "receptor", "effector"] },
  ...
  chemistry: {
    ...
    "Year 8": [
      { topic: "Chemical Reactions", keyVocabulary: ["reactant", "product", "exothermic", "endothermic", "word equation"] },
      { topic: "The Periodic Table", keyVocabulary: ["group", "period", "metal", "non-metal", "noble gas"] },
      { topic: "Earth's Atmosphere", keyVocabulary: ["atmosphere", "greenhouse effect", "carbon dioxide", "climate change", "evolution of atmosphere"] },
    ],
    "Year 9": [
      { topic: "Atomic Structure", keyVocabulary: ["proton", "neutron", "electron", "isotope", "electronic structure"] },
      { topic: "Ionic Bonding", keyVocabulary: ["ionic", "ion", "electrostatic", "lattice", "transfer"] },
      { topic: "Covalent Bonding", keyVocabulary: ["covalent", "shared pair", "molecule", "giant covalent", "polymer"] },
      { topic: "Metallic Bonding", keyVocabulary: ["metallic", "delocalised", "lattice", "conductivity", "alloy"] },
      { topic: "Rates of Reaction", keyVocabulary: ["rate", "catalyst", "concentration", "temperature", "surface area"] },
    ],
    "Year 10": [
      { topic: "Atomic Structure", keyVocabulary: ["proton", "neutron", "electron", "isotope", "electronic structure"] },
      ...
      { topic: "Covalent Bonding", keyVocabulary: ["covalent", "shared pair", "molecule", "giant covalent", "polymer"] },
      { topic: "Metallic Bonding", keyVocabulary: ["metallic", "delocalised", "lattice", "conductivity", "alloy"] },
      { topic: "Quantitative Chemistry 1: Moles & Relative Mass", keyVocabulary: ["mole", "relative atomic mass", "Avogadro", "formula mass"] },
      { topic: "Quantitative Chemistry 2: Concentration of Solutions", keyVocabulary: ["concentration", "mol/dm\u00b3", "solution", "dilution"] },
      { topic: "Quantitative Chemistry 3: Percentage Yield & Atom Economy", keyVocabulary: ["percentage yield", "atom economy", "theoretical yield", "actual yield"] },
      { topic: "Chemical Analysis", keyVocabulary: ["chromatography", "flame test", "pure substance", "formulation"] },
      { topic: "Rates of Reaction", keyVocabulary: ["rate", "catalyst", "concentration", "temperature", "surface area"] },
      { topic: "Organic Chemistry 1: Alkanes", keyVocabulary: ["alkane", "hydrocarbon", "saturated", "crude oil", "homologous series"] },
      { topic: "Organic Chemistry 2: Alkenes", keyVocabulary: ["alkene", "unsaturated", "double bond", "addition reaction", "polymerisation"] },
      { topic: "Organic Chemistry 3 \u2014 Functional Groups", keyVocabulary: ["functional group", "alcohol", "carboxylic acid", "ester", "condensation"] },
      { topic: "Polymers", keyVocabulary: ["polymer", "monomer", "addition polymerisation", "condensation polymerisation", "plastic"] },
  ...
  physics: {
    ...
    "Year 9": [
      { topic: "Waves", keyVocabulary: ["transverse", "longitudinal", "amplitude", "frequency", "wavelength"] },
      { topic: "Electromagnetic Spectrum", keyVocabulary: ["wavelength", "frequency", "gamma", "infrared", "ultraviolet"] },
      { topic: "Specific Heat Capacity", keyVocabulary: ["specific heat capacity", "energy transfer", "temperature change", "joule", "mass"] },
      { topic: "Particle Model and States of Matter", keyVocabulary: ["particle", "solid", "liquid", "gas", "state change", "latent heat"] },
      { topic: "Motion Graphs", keyVocabulary: ["distance-time", "velocity-time", "gradient", "acceleration", "displacement"] },
      { topic: "Units and Measurements", keyVocabulary: ["SI unit", "prefix", "kilo", "mega", "milli", "standard form"] },
    ],
    "Year 10": [
      { topic: "Specific Heat Capacity", keyVocabulary: ["specific heat capacity", "energy transfer", "temperature change", "joule", "mass"] },
      { topic: "Electricity and Circuits", keyVocabulary: ["current", "voltage", "resistance", "Ohm's law", "power"] },
      { topic: "Circuit Diagrams and Symbols", keyVocabulary: ["circuit", "component", "series", "parallel", "symbol"] },
      { topic: "Free Body Diagrams", keyVocabulary: ["force", "resultant", "equilibrium", "Newton", "free body diagram"] },
      { topic: "Vector and Resultant Forces", keyVocabulary: ["vector", "scalar", "resultant", "magnitude", "direction"] },
      { topic: "Waves", keyVocabulary: ["transverse", "longitudinal", "electromagnetic spectrum", "reflection", "refraction"] },
      { topic: "Ray Diagrams", keyVocabulary: ["ray diagram", "lens", "mirror", "focal point", "refraction"] },
      { topic: "Electromagnetic Spectrum", keyVocabulary: ["wavelength", "frequency", "gamma", "infrared", "ultraviolet"] },
      { topic: "Energy Transfers and Sankey Diagrams", keyVocabulary: ["Sankey diagram", "energy transfer", "efficiency", "wasted energy", "useful energy"] },
      { topic: "Half-Life Calculations", keyVocabulary: ["half-life", "radioactive decay", "activity", "count rate", "isotope"] },
      { topic: "Nuclear Decay Equations", keyVocabulary: ["alpha decay", "beta decay", "gamma emission", "nuclear equation", "mass number"] },
      { topic: "Atomic Structure and Alpha Scattering", keyVocabulary: ["nucleus", "proton", "neutron", "Rutherford", "alpha scattering"] },
      { topic: "Solar System and Star Life Cycle", keyVocabulary: ["orbit", "gravity", "planet", "star", "main sequence", "nebula"] },
      { topic: "Motion Graphs", keyVocabulary: ["distance-time", "velocity-time", "gradient", "acceleration", "displacement"] },
      { topic: "Particle Model and States of Matter", keyVocabulary: ["particle", "solid", "liquid", "gas", "state change", "latent heat"] },
      { topic: "Pressure, Fluids and Hydraulic Systems", keyVocabulary: ["pressure", "fluid", "hydraulic", "Pascal", "upthrust"] },
      { topic: "Units and Measurements", keyVocabulary: ["SI unit", "prefix", "kilo", "mega", "milli", "standard form"] },
    ],
    "Year 11": [
      { topic: "Waves", keyVocabulary: ["transverse", "longitudinal", "electromagnetic spectrum", "reflection", "refraction"] },
      { topic: "Magnetic Field Lines", keyVocabulary: ["magnetic field", "field lines", "north pole", "south pole", "solenoid"] },
      { topic: "Motor Effect and Fleming's Left-Hand Rule", keyVocabulary: ["motor effect", "Fleming's left-hand rule", "force", "current", "magnetic field"] },
      { topic: "Transformers", keyVocabulary: ["transformer", "step-up", "step-down", "turns ratio", "voltage"] },
      { topic: "Free Body Diagrams", keyVocabulary: ["force", "resultant", "equilibrium", "Newton", "free body diagram"] },
      { topic: "Vector and Resultant Forces", keyVocabulary: ["vector", "scalar", "resultant", "magnitude", "direction"] },
      { topic: "Half-Life Calculations", keyVocabulary: ["half-life", "radioactive decay", "activity", "count rate", "isotope"] },
      { topic: "Nuclear Decay Equations", keyVocabulary: ["alpha decay", "beta decay", "gamma emission", "nuclear equation", "mass number"] },
  ...
  maths: {
    ...
    "Year 9": [
      { topic: "Quadratic Equations", keyVocabulary: ["quadratic", "factorise", "expand", "roots", "parabola"] },
      { topic: "Algebra — Expanding Brackets", keyVocabulary: ["expand", "bracket", "FOIL", "simplify", "expression"] },
      { topic: "Algebra — Solving Equations", keyVocabulary: ["solve", "equation", "balance", "unknown", "linear"] },
      { topic: "Trigonometry", keyVocabulary: ["sine", "cosine", "tangent", "hypotenuse", "SOHCAHTOA"] },
      { topic: "Pythagoras' Theorem", keyVocabulary: ["hypotenuse", "right angle", "square root", "theorem"] },
      { topic: "Fractions, Decimals and Percentages", keyVocabulary: ["convert", "equivalent", "fraction", "decimal", "percentage"] },
      { topic: "Number — Indices and Surds", keyVocabulary: ["index", "power", "surd", "laws of indices", "square root"] },
      { topic: "Sequences and Series", keyVocabulary: ["term", "nth term", "arithmetic", "geometric", "sequence"] },
      { topic: "Statistics — Data Handling", keyVocabulary: ["mean", "median", "mode", "range", "frequency"] },
    ...
    "Year 10": [
      // ── Number ──
      { topic: "Number — Place Value, Ordering and Negative Numbers", keyVocabulary: ["place value", "integer", "ascending", "descending", "negative number"] },
      { topic: "Number — Four Operations, Decimals and BIDMAS", keyVocabulary: ["BIDMAS", "inverse operation", "product", "quotient", "estimate"] },
      { topic: "Number — Factors, Multiples, Primes, HCF and LCM", keyVocabulary: ["factor", "multiple", "prime number", "HCF", "LCM"] },
      { topic: "Number — Powers, Roots and Index Laws", keyVocabulary: ["square", "cube", "square root", "index", "base"] },
      { topic: "Number — Rounding, Estimation and Bounds", keyVocabulary: ["decimal place", "significant figure", "estimate", "upper bound", "lower bound"] },
      { topic: "Number — Fractions, Decimals, Percentages and Ordering", keyVocabulary: ["equivalent", "percentage", "recurring decimal", "improper fraction", "terminating decimal"] },
      { topic: "Number — Fraction Calculations", keyVocabulary: ["numerator", "denominator", "equivalent fraction", "improper fraction", "mixed number"] },
      { topic: "Number — Percentage Change and Reverse Percentages", keyVocabulary: ["percentage multiplier", "increase", "decrease", "original amount", "reverse percentage"] },
      { topic: "Number — Standard Form", keyVocabulary: ["standard form", "power of ten", "coefficient", "positive index", "negative index"] },
      { topic: "Number — Surds and Exact Values", keyVocabulary: ["surd", "exact value", "simplify", "square number", "like surds"] },
      { topic: "Number — Units, Conversions and Measures", keyVocabulary: ["convert", "millimetre", "centimetre", "kilometre", "capacity"] },
      // ── Algebra ──
      { topic: "Algebra — Notation, Like Terms and Substitution", keyVocabulary: ["variable", "coefficient", "term", "like terms", "substitute"] },
      { topic: "Algebra — Expanding Single Brackets", keyVocabulary: ["expand", "distributive law", "coefficient", "negative sign", "expression"] },
      { topic: "Algebra — Double Brackets and Factorising", keyVocabulary: ["double brackets", "factorise", "common factor", "quadratic", "binomial"] },
      { topic: "Algebra — Solving Linear Equations", keyVocabulary: ["equation", "inverse operation", "balance method", "unknown", "solution"] },
      { topic: "Algebra — Equations with Brackets and Unknowns on Both Sides", keyVocabulary: ["bracket", "balance", "expand", "collect", "unknown"] },
      { topic: "Algebra — Rearranging Formulae", keyVocabulary: ["subject", "inverse operation", "rearrange", "equation", "divide"] },
      { topic: "Algebra — Sequences and Nth Term", keyVocabulary: ["sequence", "common difference", "nth term", "position", "linear sequence"] },
      { topic: "Algebra — Quadratic and Special Sequences", keyVocabulary: ["quadratic sequence", "second difference", "triangular numbers", "square numbers", "Fibonacci"] },
      { topic: "Algebra — Straight-Line Graphs, Gradient and Intercept", keyVocabulary: ["gradient", "y-intercept", "coordinate pair", "axis", "linear"] },
      { topic: "Algebra — Equation of a Line from Points and Tables", keyVocabulary: ["gradient", "intercept", "table of values", "linear equation", "coordinate"] },
      { topic: "Algebra — Real-Life and Conversion Graphs", keyVocabulary: ["conversion graph", "rate of change", "axis", "constant speed", "intercept"] },
      { topic: "Algebra — Quadratics: Expanding, Factorising and Solving", keyVocabulary: ["quadratic", "factorise", "root", "zero product rule", "expand"] },
      { topic: "Algebra — Quadratic Formula and Completing the Square", keyVocabulary: ["quadratic formula", "discriminant", "complete the square", "root", "vertex"] },
      { topic: "Algebra — Simultaneous Equations", keyVocabulary: ["simultaneous equations", "elimination", "substitution", "solution", "linear"] },
      { topic: "Algebra — Linear Inequalities and Number Lines", keyVocabulary: ["inequality", "solution set", "open circle", "closed circle", "number line"] },
      { topic: "Algebra — Graphical Inequalities", keyVocabulary: ["boundary line", "solid line", "dashed line", "region", "test point"] },
      { topic: "Algebra — Functions and Iteration", keyVocabulary: ["function", "input", "output", "function notation", "iteration"] },
      { topic: "Algebra — Algebraic Fractions", keyVocabulary: ["algebraic fraction", "factorise", "cancel", "denominator", "numerator"] },
      // ── Ratio, Proportion and Rates of Change ──
      { topic: "Ratio, Proportion and Rates of Change — Simplifying and Sharing Ratio", keyVocabulary: ["ratio", "simplest form", "share in a ratio", "part", "total parts"] },
      { topic: "Ratio, Proportion and Rates of Change — Scale Drawings and Scale Factors", keyVocabulary: ["scale", "scale factor", "actual length", "drawing length", "area scale factor"] },
      { topic: "Ratio, Proportion and Rates of Change — Rates and Compound Measures", keyVocabulary: ["rate", "speed", "density", "pressure", "compound measure"] },
      { topic: "Ratio, Proportion and Rates of Change — Direct and Inverse Proportion", keyVocabulary: ["direct proportion", "inverse proportion", "constant of proportionality", "scale factor", "variable"] },
      { topic: "Ratio, Proportion and Rates of Change — Growth, Decay and Compound Interest", keyVocabulary: ["growth", "decay", "compound interest", "depreciation", "multiplier"] },
