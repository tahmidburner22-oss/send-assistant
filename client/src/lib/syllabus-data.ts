...
export const SYLLABUS_DATA: Record<string, Partial<Record<YearGroupKey, SyllabusTopic[]>>> = {
  ...
  english: {
    ...
    "Year 10": [
      { topic: "Shakespeare — Macbeth", keyVocabulary: ["tragedy", "ambition", "fate", "soliloquy", "dramatic irony"] },
      { topic: "Shakespeare — Romeo and Juliet", keyVocabulary: ["tragedy", "fate", "love", "conflict", "soliloquy"] },
      { topic: "19th Century Novel — A Christmas Carol", keyVocabulary: ["Victorian", "morality", "redemption", "social responsibility", "Dickens"] },
      { topic: "19th Century Novel — Strange Case of Dr Jekyll and Mr Hyde", keyVocabulary: ["Victorian", "duality", "repression", "science", "morality"] },
      { topic: "Modern Text — An Inspector Calls", keyVocabulary: ["social class", "responsibility", "capitalism", "Priestley", "dramatic irony"] },
      { topic: "Modern Text — Lord of the Flies", keyVocabulary: ["allegory", "civilisation", "savagery", "power", "Golding"] },
      { topic: "Poetry Anthology — Power and Conflict", keyVocabulary: ["comparison", "structure", "imagery", "conflict", "context"] },
      { topic: "Poetry Anthology — Love and Relationships", keyVocabulary: ["comparison", "structure", "imagery", "love", "context"] },
