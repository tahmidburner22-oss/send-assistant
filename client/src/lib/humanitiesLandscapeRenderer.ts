...
function styles(): string {
  return `
    ...
    * { box-sizing: border-box; }
    ...
    .english-analysis .mini { min-height:30mm; }
    .english-analysis .mini .linebox { min-height:8mm; margin-top:1mm; margin-bottom:1mm; }
    .english-question-row .linebox { min-height:7mm; margin-top:1mm; margin-bottom:1mm; }
    .english-question-row .card p { margin-top:1.5mm; margin-bottom:1.5mm; }
