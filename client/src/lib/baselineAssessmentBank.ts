...
export interface BaselineQuestion {
  ...
  /** Optional keyword groups for transparent partial credit in a multi-mark response. */
...
const short = (
  ...
  context?: string,
  partialMarkKeywords?: string[][],
): BaselineQuestion => ({ id, subject, yearGroup, domain, kind: "short-answer", prompt, correctAnswer, acceptedAnswers, explanation, marks, suggestedSeconds, curriculumReference, context, partialMarkKeywords });
...
export const BASELINE_BANKS: Record<BaselineSubject, Record<string, BaselineQuestion[]>> = {
  mathematics: {
    "Year 7": [
      ...
      choice("mathematics", "Year 7", "y7m-probability", "Probability", "A bag contains 3 red, 5 blue and 2 green counters. What is the probability of choosing a green counter?", ["1/5", "2/5", "1/2", "3/10"], "1/5", "There are 2 green counters out of 10 in total; 2/10 simplifies to 1/5.", 2, 180, "KS3 probability"),
    ...
    "Year 11": [
      ...
      short("mathematics", "Year 11", "y11m-simultaneous-nonlinear", "Algebra", "Solve y = x + 1 and y = x² - 5. Give the x-values.", "-2, 3", "Set x + 1 = x² - 5, then solve x² - x - 6 = 0.", 3, 240, "GCSE algebra: simultaneous equations", ["-2,3", "3, -2", "3,-2", "x=-2, x=3", "x=3, x=-2"]),
      ...
      short("mathematics", "Year 11", "y11m-cosine-rule", "Geometry", "Two sides of a triangle are 7 cm and 9 cm with included angle 60°. Calculate the third side to 2 decimal places.", "8.19", "Use c² = a² + b² - 2ab cos C = 49 + 81 - 63 = 67, so c = √67 = 8.185... and rounds to 8.19 cm.", 4, 300, "GCSE geometry: cosine rule", ["8.19 cm", "8.185", "8.18535"]),
  ...
  english: {
    "Year 7": [
      ...
      choice("english", "Year 7", "y7e-punctuation", "Grammar and punctuation", "Which version punctuates the question and reporting clause correctly?", ["\"When did you arrive?\" asked Sam.", "When did you arrive, asked Sam?", "\"When did you arrive,\" asked Sam?", "When did you arrive? Asked Sam."], "\"When did you arrive?\" asked Sam.", "Direct speech needs quotation marks, a capital letter and a question mark before the lower-case reporting clause.", 1, 90, "KS3 punctuation"),
      ...
      choice("english", "Year 7", "y7e-sentence", "Writing craft", "Which conjunction best completes the sentence: 'Leila stayed indoors ___ the storm became severe.'", ["because", "although", "unless", "while"], "because", "'Because' gives the intended cause for Leila staying indoors.", 1, 90, "KS3 sentence construction"),
      ...
      choice("english", "Year 7", "y7e-summary", "Reading", "Which word best describes the mood in: 'The empty corridor echoed with each careful step.'", ["eerie", "cheerful", "relaxed", "triumphant"], "eerie", "The empty, echoing corridor creates an eerie and unsettling mood.", 1, 90, "KS3 summarising"),
      ...
      choice("english", "Year 7", "y7e-compare", "Reading", "Text A calls a storm 'wild'. Text B calls it 'gentle'. Which comparison is most accurate?", ["Text A presents the storm as dangerous while Text B presents it as calm.", "Both texts present the storm as dangerous.", "Text A presents the storm as calm while Text B presents it as violent.", "Both texts present the storm as gentle."], "Text A presents the storm as dangerous while Text B presents it as calm.", "'Wild' suggests danger, whereas 'gentle' suggests calmness.", 1, 120, "KS3 comparison"),
    ],
    "Year 8": [
      ...
      short("english", "Year 8", "y8e-semicolon", "Grammar and punctuation", "Write the punctuation mark that joins these two closely related clauses into one sentence: The path was steep ___ we continued climbing.", ";", "A semicolon joins two closely related independent clauses without a coordinating conjunction.", 1, 120, "KS3 sentence punctuation", ["semicolon"]),
      ...
      choice("english", "Year 8", "y8e-language", "Reading", "Which quality does the word 'maze' most directly suggest in 'the city was a maze of glass'?", ["confusing and disorientating", "friendly and familiar", "empty and silent", "natural and rural"], "confusing and disorientating", "A maze is difficult to navigate, so it suggests a confusing, disorientating city.", 1, 120, "KS3 language analysis"),
      ...
      choice("english", "Year 8", "y8e-compare", "Reading", "Text A uses 'marched' and Text B uses 'wandered'. Which comparison is most accurate?", ["Text A is purposeful while Text B is aimless.", "Both texts present movement as hurried.", "Text A is relaxed while Text B is controlled.", "Both texts present movement as dangerous."], "Text A is purposeful while Text B is aimless.", "'Marched' suggests determined movement, while 'wandered' suggests a lack of direction.", 1, 120, "KS3 comparison"),
      ...
      choice("english", "Year 8", "y8e-summary", "Reading", "Which phrase best summarises: 'The abandoned boat rocked slowly, its sail torn and its deck covered in salt.'", ["The boat is damaged and abandoned.", "The boat is new and carefully repaired.", "The boat is sailing quickly towards land.", "The boat is crowded with travellers."], "The boat is damaged and abandoned.", "The words 'abandoned' and 'torn' identify the two key summary ideas.", 1, 120, "KS3 summarising"),
      choice("english", "Year 8", "y8e-craft", "Writing craft", "Which sentence begins with a fronted adverbial and creates a tense setting?", ["Without warning, the lights failed.", "The lights failed without warning.", "The failing lights were worrying.", "Lights were failing in the building."], "Without warning, the lights failed.", "The opening adverbial 'Without warning' establishes a sudden, tense atmosphere before the main clause.", 1, 120, "KS3 descriptive writing"),
    ],
    "Year 9": [
      ...
      choice("english", "Year 9", "y9e-analysis", "Language analysis", "Which explanation of 'a fragile thread of hope' is most precise?", ["Hope is weak and could easily be broken.", "Hope is permanent and powerful.", "Hope is humorous and carefree.", "Hope is hidden because it is loud."], "Hope is weak and could easily be broken.", "'Fragile' suggests something delicate that could break, so hope seems uncertain.", 1, 120, "KS3 analytical writing"),
      ...
      short("english", "Year 9", "y9e-viewpoint", "Writing craft", "Give one feature of a persuasive speech that would engage an audience.", "rhetorical question", "A persuasive feature should make the audience think, feel involved or respond emotionally.", 1, 120, "KS3 persuasive writing", ["rhetorical question", "rule of three", "direct address", "emotive language"]),
      short("english", "Year 9", "y9e-accurate", "Grammar and punctuation", "Rewrite accurately: despite the rain we kept walking however we arrived late", "Despite the rain, we kept walking; however, we arrived late.", "Use a comma after the opening phrase. A semicolon or full stop can correctly separate the two clauses before 'however'.", 3, 240, "KS3 sentence control", ["Despite the rain, we kept walking; however, we arrived late.", "Despite the rain, we kept walking. However, we arrived late."]),
    ...
    "Year 10": [
      ...
      choice("english", "Year 10", "y10e-wordeffect", "Language analysis", "Which explanation of the verb 'swallowed' in 'the street swallowed the last light' is most precise?", ["It suggests darkness takes over completely.", "It suggests the street becomes brighter.", "It suggests the street is welcoming.", "It suggests the light moves slowly upward."], "It suggests darkness takes over completely.", "'Swallowed' suggests darkness consumes the remaining light, creating an ominous sense of finality.", 1, 120, "GCSE English Language AO2"),
      choice("english", "Year 10", "y10e-inference", "Reading", "A character keeps their coat on indoors and avoids eye contact. Which inference is best supported?", ["The character feels uncomfortable and may want to leave.", "The character is celebrating a success.", "The character is confident and relaxed.", "The character is preparing to perform on stage."], "The character feels uncomfortable and may want to leave.", "Keeping a coat on indoors and avoiding eye contact can suggest discomfort and a wish to leave.", 1, 120, "GCSE English Language AO1"),
      choice("english", "Year 10", "y10e-structure", "Structure", "A writer begins with an empty house and then introduces a single lit room. What is the most precise effect of the narrowed focus?", ["It draws attention to the lit room and creates intrigue.", "It makes the setting seem cheerful and busy.", "It proves that the house is safe.", "It removes all mystery from the setting."], "It draws attention to the lit room and creates intrigue.", "Narrowing from the empty house to one lit room focuses the reader and creates mystery.", 1, 120, "GCSE English Language AO2"),
      ...
      short("english", "Year 10", "y10e-punctuation", "Technical accuracy", "Add the missing punctuation: The committee agreed that the plan was risky nevertheless it approved it", "The committee agreed that the plan was risky; nevertheless, it approved it.", "A semicolon with a following comma, or a full stop before capitalised 'Nevertheless', correctly separates the clauses.", 3, 240, "GCSE English Language AO6", ["The committee agreed that the plan was risky; nevertheless, it approved it.", "The committee agreed that the plan was risky. Nevertheless, it approved it."]),
      short("english", "Year 10", "y10e-literature", "Literature", "Name one dramatic method a writer could use to show a character has power.", "stage directions", "A valid response identifies a dramatic method that can shape status, movement, speech or audience response.", 1, 120, "GCSE English Literature methods", ["stage direction", "stage directions", "dialogue", "imperatives", "lighting", "props", "costume", "blocking", "silence", "pause"]),
      ...
      choice("english", "Year 10", "y10e-evaluate", "Evaluation", "Which reason best explains why a first-person narrator may be unreliable?", ["They may be biased by their own viewpoint.", "They always know every character's thoughts.", "They cannot describe events.", "They are always objective."], "They may be biased by their own viewpoint.", "A first-person narrator offers a limited personal viewpoint and may be biased.", 1, 120, "GCSE English Language evaluation"),
      short("english", "Year 10", "y10e-vocab", "Vocabulary", "Choose an analytical verb to complete: 'The writer ___ the reader to question the decision.'", "encourages", "An analytical verb states the writer's effect deliberately.", 1, 90, "GCSE analytical vocabulary", ["encourages", "invites", "persuades", "urges", "prompts"]),
      short("english", "Year 10", "y10e-transactional", "Writing craft", "Give one structural feature suitable for an article aimed at teenagers.", "subheading", "A valid feature helps organise material for the intended audience.", 1, 120, "GCSE English Language AO5", ["subheading", "headline", "short paragraphs", "paragraph", "image", "caption", "bullet points"]),
    ],
    "Year 11": [
      ...
      choice("english", "Year 11", "y11e-synthesis", "Comparison", "Text A describes a beach as 'silent'; Text B describes it as 'buzzing'. Which comparison is most accurate?", ["Text A presents the beach as quiet while Text B presents it as busy.", "Both texts present the beach as peaceful.", "Text A presents danger while Text B presents safety.", "Both texts present the beach as empty."], "Text A presents the beach as quiet while Text B presents it as busy.", "The contrast between 'silent' and 'buzzing' shows quietness in Text A and activity in Text B.", 1, 120, "GCSE English Language AO3"),
      choice("english", "Year 11", "y11e-evaluation", "Evaluation", "Which word most strongly supports the claim that the setting feels hostile?", ["snarled", "strolled", "glimmered", "rested"], "snarled", "'Snarled' gives the gates an aggressive, animal-like quality, supporting a hostile impression.", 1, 120, "GCSE English Language AO4", "The gates snarled in the dark, their iron teeth closing around the path."),
      short("english", "Year 11", "y11e-rhetoric", "Writing craft", "Name the technique in 'How much longer can we ignore this problem?'.", "rhetorical question", "The question is asked for effect rather than an answer.", 1, 90, "GCSE English Language AO5", ["rhetorical question", "rhetorical interrogative"]),
      short("english", "Year 11", "y11e-sentence", "Technical accuracy", "Correct this sentence, referring to one school: its clear the school plans need revising", "It's clear the school's plans need revising.", "Use it's for 'it is' and school's for singular possession.", 3, 210, "GCSE English Language AO6", ["It's clear the school's plans need revising.", "It's clear. The school's plans need revising."]),
      short("english", "Year 11", "y11e-literature-method", "Literature", "Give one effect a playwright may create through dramatic irony.", "tension", "Dramatic irony lets the audience know more than a character, which can create tension, suspense, humour or sympathy.", 1, 120, "GCSE English Literature methods", ["create tension", "suspense", "create suspense", "humour", "create humour", "sympathy", "create sympathy"]),
      ...
      short("english", "Year 11", "y11e-form", "Writing craft", "Name one feature of an effective formal letter conclusion.", "a clear call to action", "A conclusion can make a clear request, summarise purpose or use an appropriate formal sign-off.", 1, 120, "GCSE English Language AO5", ["call to action", "clear request", "sign off", "formal sign off", "summary", "summarise purpose"]),
      choice("english", "Year 11", "y11e-vocab", "Vocabulary", "Which formal adjective means angry because something feels unfair?", ["indignant", "content", "reluctant", "fragile"], "indignant", "Indignant means angry because of perceived unfairness or injustice.", 1, 90, "GCSE analytical vocabulary"),
      choice("english", "Year 11", "y11e-judgement", "Evaluation", "Which completion gives the strongest evaluation? 'The writer's use of short sentences is effective because ...'", ["it creates tension at the moment of danger.", "there are several sentences.", "the writer has used full stops.", "the paragraph is not very long."], "it creates tension at the moment of danger.", "A strong evaluation names a precise effect and connects it to the moment in the text.", 1, 120, "GCSE English Language AO4"),
    ],
  },
  science: {
    "Year 7": [
      ...
      short("science", "Year 7", "y7s-plant", "Biology", "Write the word equation for photosynthesis.", "carbon dioxide + water -> glucose + oxygen", "Award one mark for each correct substance: carbon dioxide, water, glucose and oxygen. Light is the energy source and is not one of the four substance marks.", 4, 240, "KS3 biology: photosynthesis", ["carbon dioxide + water = glucose + oxygen"], undefined, [["carbon dioxide", "co2"], ["water", "h2o"], ["glucose", "sugar"], ["oxygen", "o2"]]),
      ...
      short("science", "Year 7", "y7s-risk", "Working scientifically", "State one safety precaution when heating a test tube.", "wear safety goggles", "Valid precautions include eye protection, using a holder, pointing the opening away from people, tying back long hair or heating gently.", 1, 150, "KS3 laboratory safety", ["goggles", "wear goggles", "wear safety goggles", "use a test tube holder", "test tube holder", "point away from people", "point the opening away", "tie back long hair", "heat gently"]),
    ],
    "Year 8": [
    ...
    "Year 9": [
      ...
      short("science", "Year 9", "y9s-risk", "Working scientifically", "State one reason a risk assessment is carried out before a practical.", "to identify hazards", "A risk assessment identifies what could cause harm before suitable control measures are chosen.", 1, 120, "GCSE readiness: practical skills", ["identify hazards", "identify risks", "identify what could cause harm"]),
    ],
    "Year 10": [
      ...
      short("science", "Year 10", "y10s-moles", "Chemistry", "Calculate the relative formula mass (Mr) of CO₂. (C = 12, O = 16)", "44", "Mr is unitless: 12 + (2 × 16) = 44.", 1, 90, "GCSE Chemistry: quantitative chemistry", ["44 g/mol", "44 g mol-1"]),
    ...
    "Year 11": [
      ...
      short("science", "Year 11", "y11s-rate", "Chemistry", "Give one change that would increase the rate of reaction between marble chips and acid.", "increase temperature", "Higher temperature increases collision frequency and energy; increasing surface area or acid concentration are also valid.", 1, 120, "GCSE Chemistry: rates", ["increase surface area", "use smaller chips", "powdered marble", "increase concentration", "increase acid concentration"]),
      ...
      short("science", "Year 11", "y11s-uncertainty", "Working scientifically", "A ruler has millimetre divisions. State a reasonable uncertainty for one length reading in mm.", "±0.5", "A reasonable reading uncertainty is often half the smallest scale division, so ±0.5 mm. ±1 mm can also be justified where readings are recorded only to the nearest millimetre.", 1, 120, "GCSE practical skills", ["±0.5", "±0.5 mm", "+/-0.5", "0.5 mm", "±1", "±1 mm", "+/-1"]),
