...
1. SELF REFLECTION — emit a section with type "self-reflection" containing ONLY a single exit ticket question. Do NOT include a confidence grid, I-can statements, or written reflection prompts — these have been removed as they make the worksheet too long.
...
The Self-Reflection exit ticket appears on the pupil-facing page (NOT teacher-only) and sits on its own page break before the Teacher Copy below. Do not bury the exit ticket inside the teacher copy — the pupil must see it. Do NOT emit a confidence grid or written prompts.
...
- SELF REFLECTION: Emit ONLY a single exit ticket question. Do NOT include a confidence grid, I-can statements, or written reflection prompts — these have been removed as they make the worksheet too long. The exit ticket sentence MUST contain the topic name. Format: SUBTITLE: Quick exit question:\nEXIT_TICKET: Write ONE thing you learned today about ${params.topic} in a single sentence.
...
Return EXACTLY this JSON (raw JSON only):
{
  ...
  "sections": [
    ...
    {"title": "Self Reflection", "type": "self-reflection", "teacherOnly": false, "content": "SUBTITLE: Quick exit question:\nEXIT_TICKET: Write ONE thing you learned today about ${params.topic} in a single sentence:"},
