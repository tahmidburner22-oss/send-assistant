...
const scienceBuilders: ItemBuilder[] = [
  v => choice("science", `s-cell-${v}`, "Biology", "Which cell structure controls the activities of the cell?", ["Cell wall", "Nucleus", "Chlorophyll", "Vacuole"], "Nucleus", "The nucleus contains genetic material and controls cell activities."),
