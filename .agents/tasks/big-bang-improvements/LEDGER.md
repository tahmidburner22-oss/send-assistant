...
Last bulk-updated: 2026-05-26 (status text cleanup — PR #87, #90, #91 and the combined PR-19..27 batch verified on main; "pending" suffix dropped. PR-19..27 merge SHA not recorded in handoff history but every file is on main per the registry inspection on 2026-05-26).
...
| 16 | Common Mistakes for non-maths                                                         | PR-13  | shipped — combined PR-19..27 (verified on main) |
| 17 | Misconception bank backing (formal registry)                                          | PR-13  | shipped — combined PR-19..27 (verified on main) |
| 18 | Self-Reflection: command-word echo guarantee                                          | PR-2   | shipped — PR #86 |
| 19 | Revision-Tips: time-budget reconcile with estimatedTime                               | PR-13  | shipped — combined PR-19..27 (verified on main) |
...
| 22 | Diagram coverage gap teacher-facing badge (UI side)                                   | PR-6   | shipped — combined PR-19..27 (verified on main) |
...
| 31 | Class Pack visual diff                                                                | PR-6   | shipped — combined PR-19..27 (verified on main) |
| 32 | Trauma-informed register profile                                                      | PR-16  | shipped — PR #102 (combined PR-10..18) |
| 33 | Bilingual MFL revision shell                                                          | PR-25  | shipped — combined PR-19..27 (verified on main) |
| 34 | Per-pupil progression check (longitudinal Bloom ramp)                                 | PR-19  | shipped — combined PR-19..27 (verified on main) |
| 35 | Spec-point completeness over a Scheme of Work                                         | PR-19  | shipped — combined PR-19..27 (verified on main) |
| 36 | Cross-paper synoptic generation for KS5                                               | PR-25  | shipped — combined PR-19..27 (verified on main) |
| 37 | Required Practical (RP) coverage tracker over a SoW                                   | PR-19  | shipped — combined PR-19..27 (verified on main) |
| 38 | Past-paper question-frequency anchor                                                  | PR-19  | shipped — combined PR-19..27 (verified on main) |

## B. Generator architecture (39–78)

| #  | Item                                                                                  | PR     | Status      |
| -- | ------------------------------------------------------------------------------------- | ------ | ----------- |
| 39 | Server-side prompt unification (port manifesto into server/routes/ai.ts)              | PR-7   | shipped — PR #91 |
...
| 45 | A/B prompt experiment framework                                                       | PR-20  | shipped — combined PR-19..27 (verified on main) |
| 46 | Per-subject prompt families refactor                                                  | PR-20  | shipped — combined PR-19..27 (verified on main) |
| 47 | Self-consistency sampling on extended-answer questions                                | PR-20  | shipped — combined PR-19..27 (verified on main) |
| 48 | Citation-grounded factual layer (history dates, science values, English Lit quotes)   | PR-20  | shipped — combined PR-19..27 (verified on main) |
| 49 | Promote postValidatorWarnings to tiered SLA P0 / P1 / P2                              | PR-22  | shipped — combined PR-19..27 (verified on main) |
| 50 | Quality scorecard implementation (WorksheetQAScore actually computed)                 | PR-4   | shipped — PR #88 |
| 51 | Generator-version baseline + regression detector                                      | PR-22  | shipped — combined PR-19..27 (verified on main) |
| 52 | Idempotency proof in tests (every validator runs twice, deep-equal output)            | PR-21  | shipped — combined PR-19..27 (verified on main) |
| 53 | Schema deprecation policy                                                             | PR-22  | shipped — combined PR-19..27 (verified on main) |
| 54 | Diagram lookup miss → admin-gated AI-generated SVG fallback                           | PR-23  | shipped — combined PR-19..27 (verified on main) |
| 55 | Diagram requestability ranking                                                        | PR-23  | shipped — combined PR-19..27 (verified on main) |
| 56 | Diagram complexity / page-fit budget                                                  | PR-23  | shipped — combined PR-19..27 (verified on main) |
| 57 | Vector-only diagrams for printing                                                     | PR-23  | shipped — combined PR-19..27 (verified on main) |
| 58 | DOCX / PDF feature parity audit                                                       | PR-24  | shipped — combined PR-19..27 (verified on main) |
| 59 | Print-bleed and stapling-edge guarantee                                               | PR-24  | shipped — combined PR-19..27 (verified on main) |
| 60 | A3 / A5 / leaflet booklet presets                                                     | PR-24  | shipped — combined PR-19..27 (verified on main) |
...
| 70 | Telemetry: which validator fires most often                                           | PR-27  | shipped — combined PR-19..27 (verified on main) |
| 71 | Per-topic regeneration heat-map                                                       | PR-27  | shipped — combined PR-19..27 (verified on main) |
| 72 | Ban whole-file reads of ai.ts / Worksheets.tsx / WorksheetRenderer.tsx in CI tooling  | PR-21  | shipped — combined PR-19..27 (verified on main) |
| 73 | ai.ts second carve-up by prompt section                                               | PR-21  | shipped — combined PR-19..27 (verified on main) |
| 74 | Data-driven post-validator chain                                                      | PR-8   | shipped — PR #92 |
| 75 | Property-based tests on builders                                                      | PR-21  | shipped — combined PR-19..27 (verified on main) |
| 76 | Logging redaction for pupil names + IEP content                                       | PR-9   | shipped — PR #94 (partial) |
| 77 | Snapshot tests by (subject × year × send-need × ability tier) matrix                  | PR-21  | shipped — combined PR-19..27 (verified on main) |
| 78 | Crash-free render rate metric                                                         | PR-22  | shipped — combined PR-19..27 (verified on main) |
...
| 80 | "Edit my worksheet" surface that learns                                               | PR-25  | shipped — combined PR-19..27 (verified on main) |
| 81 | Pupil-facing companion app (consumes companionShare / hint ladders)                   | PR-26  | shipped — combined PR-19..27 (verified on main) |
| 82 | Stack multiple SEND profiles per worksheet (sendNeed → sendNeeds[])                   | PR-16  | shipped — PR #102 (combined PR-10..18) |
| 83 | Subject-vocabulary library audit                                                      | PR-19  | shipped — combined PR-19..27 (verified on main) |
| 84 | Spec-point taxonomy completeness audit                                                | PR-19  | shipped — combined PR-19..27 (verified on main) |
| 85 | Document the public LLM-output contract                                               | PR-22  | shipped — combined PR-19..27 (verified on main) |
