...
| 41 | Structured-output retry with diagnostic-only re-prompt                                | PR-9   | shipped — PR-9 |
| 42 | Token budget transparency (PD13)                                                      | PR-9   | shipped — PR-9 |
| 43 | Generation cache by hash key (PD13)                                                   | PR-9   | shipped — PR-9 |
...
| 76 | Logging redaction for pupil names + IEP content                                       | PR-9   | shipped — PR-9 (partial) |
