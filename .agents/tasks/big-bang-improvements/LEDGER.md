...
| 4  | Distractor pedagogy audit on MCQs                                                     | PR-3   | shipped — PR pending |
...
| 10 | Vocabulary tier audit (Tier 3 words declared in Word Bank)                            | PR-3   | shipped — PR pending |
| 11 | Cross-curricular UK context whitelist                                                 | PR-2   | not started |
| 12 | Cultural-context bias audit (PD9)                                                     | PR-12  | not started |
| 13 | Mathematical notation hygiene (× vs x, − vs -, ° vs o)                                | PR-3   | shipped — PR pending |
| 14 | SI unit normalisation (mph → km/h, lbs → kg, °F → °C, in/ft → cm/m)                   | PR-2   | not started |
| 15 | Diagram-question coupling check                                                       | PR-3   | shipped — PR pending |
