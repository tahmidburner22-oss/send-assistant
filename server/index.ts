...
import symbolProxyRouter from "./routes/symbol-proxy.js";
import generationProxyRouter from "./routes/generation-proxy.js";
...
app.use(helmet({
  contentSecurityPolicy: {
    directives: {
      ...
      fontSrc: ["'self'", "fonts.gstatic.com", "https://cdn.jsdelivr.net", "data:"],
...
app.use("/api/image-proxy", aiLimiter, imageProxyRouter);
app.use("/api/symbol-proxy", aiLimiter, symbolProxyRouter);
app.use("/api/generation-proxy", aiLimiter, generationProxyRouter);
